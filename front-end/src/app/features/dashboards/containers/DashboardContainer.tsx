                    ...
                    >
                      <Button
                        ...
                        className={classNames("btn-simple", {
                          active: props.bigChartData === "data1"
                        })}
                        color="info"
                        id="0"
                        size="sm"
                        onClick={() => props.setBgChartData("data1")}
                      >
                        <input
                          defaultChecked
                          className="d-none"
                      ...
                      <Button
                        ...
                        tag="label"
                        className={classNames("btn-simple", {
                          active: props.bigChartData === "data2"
                        })}
                        onClick={() => props.setBgChartData("data2")}
                      >
                        <input
                          className="d-none"
                          name="options"
                      ...
                      <Button
                        ...
                        tag="label"
                        className={classNames("btn-simple", {
                          active: props.bigChartData === "data3"
                        })}
                        onClick={() => props.setBgChartData("data3")}
                      >
                        <input
                          className="d-none"
                          name="options"
